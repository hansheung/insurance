<?php 
    ...
    function get_content() {
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $query="INSERT INTO messages (sender_id, receiver_id, message) VALUES ('$user_id', '$admin_id', '$message')";
        mysqli_query($cn, $query);
        header('Location: user_chat.php'); // Refresh page
    }
?>
 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Direct Chats with <b><?php echo $user_name;?></b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
